...
import logo from '../Instacart-Logo.svg'
    ...
    return(
        <div>
            <Navbar bg="light" expand="lg">
                <Navbar.Brand style={{margin: "5px 0 0 20px"}} href="#home"><img src={logo} alt="logo"/></Navbar.Brand>
                <Navbar.Toggle aria-controls="basic-navbar-nav"/>
                <Navbar.Collapse id="basic-navbar-nav" style={{justifyContent: "right"}}>
                    <Nav className="mr-auto">
                    </Nav>
                    <Nav style={{padding: "24px 4px 20px 40px", fontSize: "18px", lineHeight: "26px", fontWeight: "bolder", display: "flex"}}>
